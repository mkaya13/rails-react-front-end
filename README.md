...
# 📖 Rails React Front End <a name="about-project"></a>

The project is an exercise to create the front-end layer of the rails-react project.

You can find the back-end layer of this app in this [link](https://github.com/mkaya13/rails-react-back-end)
